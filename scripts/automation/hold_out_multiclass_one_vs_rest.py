...
bin_ind = "scripts/multiclass_one_vs_rest/models/hold_out/label_independent/"
bin_dep = "scripts/multiclass_one_vs_rest/models/hold_out/label_dependent/"
...
for file in tqdm(files, desc="Hold-Out Multiclass (OvR) Models"):
    home = os.getcwd()
