...
bin_ind = "scripts/multiclass_one_vs_one/models/hold_out/label_independent/"
bin_dep = "scripts/multiclass_one_vs_one/models/hold_out/label_dependent/"
...
for file in tqdm(files, desc="Hold-Out Multiclass (OvO) Models"):
    home = os.getcwd()
