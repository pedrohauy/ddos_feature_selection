...
mul_ind = "scripts/multiclass_one_vs_rest/models/cross_validation/label_independent/"
mul_dep = "scripts/multiclass_one_vs_rest/models/cross_validation/label_dependent/"
