...
bin_ind = "scripts/multiclass_categorical/models/hold_out/label_independent/"
bin_dep = "scripts/multiclass_categorical/models/hold_out/label_dependent/"
...
for file in tqdm(files, desc="Hold-Out Multiclass Models"):
    home = os.getcwd()
