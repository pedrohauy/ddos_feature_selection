...
plt.savefig(root + 'pictures/multiclass_one_vs_one/label_dependent/confusion_matrix_relieff.pdf', bbox_inches='tight')
...
filename = root + "pickles/multiclass_one_vs_one/hold_out/label_dependent/relieff.pkl"
