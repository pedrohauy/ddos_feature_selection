...
plt.savefig(root + 'pictures/multiclass_one_vs_one/label_independent/confusion_matrix_pre.pdf', bbox_inches='tight')
...
filename = root + "pickles/multiclass_one_vs_one/hold_out/label_independent/pre.pkl"
