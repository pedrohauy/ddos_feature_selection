...
for train_index, test_index in tqdm(skf.split(X, y), desc="Training Multiclass Classifier (OvR)", total=splits):
...
filename = root + "pickles/multiclass_one_vs_rest/pfm_basic.pkl"
