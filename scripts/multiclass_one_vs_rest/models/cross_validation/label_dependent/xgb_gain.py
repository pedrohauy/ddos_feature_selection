...
for features in tqdm(range(1,max_features), desc="Embedded (XGBoost) Feature Selection"):
...
filename = root + "pickles/multiclass_one_vs_rest/cross_validation/label_dependent/xgb_gain.pkl"
