...
for train_index, test_index in tqdm(skf.split(X, y), desc="Basic Methods Feature Selection", total=splits):
...
filename = root + "pickles/multiclass_one_vs_rest/cross_validation/label_independent/basic.pkl"
