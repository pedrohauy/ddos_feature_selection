...
plt.savefig(root + 'pictures/multiclass_one_vs_rest/label_independent/confusion_matrix_basic.pdf', bbox_inches='tight')
...
filename = root + "pickles/multiclass_one_vs_rest/hold_out/label_independent/basic.pkl"
