...
plt.savefig(root + 'pictures/binary/label_dependent/confusion_matrix_rfe.pdf', bbox_inches='tight')
...
filename = root + "pickles/binary/hold_out/label_dependent/rfe.pkl"
