...
plt.savefig(root + 'pictures/binary/label_dependent/confusion_matrix_xgb_gain.pdf', bbox_inches='tight')
...
filename = root + "pickles/binary/hold_out/label_dependent/xgb_gain.pkl"
