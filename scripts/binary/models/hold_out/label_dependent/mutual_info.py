...
plt.savefig(root + 'pictures/binary/label_dependent/confusion_matrix_mutual_info.pdf', bbox_inches='tight')
...
filename = root + "pickles/binary/hold_out/label_dependent/mutual_info.pkl"
