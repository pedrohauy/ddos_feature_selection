...
plt.savefig(root + 'pictures/binary/label_independent/confusion_matrix_basic.pdf', bbox_inches='tight')
...
filename = root + "pickles/binary/hold_out/label_independent/basic.pkl"
