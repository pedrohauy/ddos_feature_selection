...
plt.savefig(root + 'pictures/general/multiclass_correlation.png', bbox_inches='tight')
...
df_no_correlation.to_csv(root + "datasets/multiclass/processed/CICDDoS_corr.csv")