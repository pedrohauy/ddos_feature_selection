...
for train_index, test_index in tqdm(skf.split(X, y), desc="Training Multiclass Classifier", total=splits):
...
filename = root + "pickles/multiclass_categorical/pfm_basic.pkl"
